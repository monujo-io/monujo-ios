...
@interface WalletManager() {
    Monero::WalletManager* m_walletManagerImpl;
}
...
+ (WalletManager* ) getInstance {
    return [[WalletManager alloc] initWithWalletManager: Monero::WalletManagerFactory::getWalletManager()];
}

- (instancetype)initWithWalletManager: (Monero::WalletManager*) walletManagerImpl {
    self = [super init];
...
- (bool) closeWallet: (Wallet *) wallet {
    return m_walletManagerImpl->closeWallet((Monero::Wallet*)[wallet internal]);
}
